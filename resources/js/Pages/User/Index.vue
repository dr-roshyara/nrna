    ...
    <app-layout>
        ...
        <div class="p-2 min-h-screen">
            <div class="w-full mx-auto text-center">
                ...
                <div class="bg-gray-200 m-2 rounded-xl">
                    <div class="w-full text-lg font-bold text-left p-2 m-1">
                        Search by:
                    </div>
                    <div class="flex flex-row">
                        ...
                        <!-- next -->
                        <div class="p-2 m-1">
                            <label for="nrna_id">Membership ID</label>
                            <input
                                id="nrna_id"
                                type="text"
                    ...
                    <table class="table-auto w-full">
                        ...
                        <tbody>
                            <tr
                                ...
                                :key="index"
                                :class="{
                                    'bg-gray-100 my-6 py-2 ': index % 2 === 0,
                                    'my-6 py-2 bg-white': index % 2 > 0,
                                }"
                            >
                                <th
                                    class="
                                ...
                                >
                                    <sendmessage
                                        v-bind:vtelephone="user.telephone"
                                    >
                                    </sendmessage>
                                </th>
                            </tr>
