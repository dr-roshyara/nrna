            ...
            <!--  Here comes the filtering  -->
                ...
                <div class="table w-full p-2">
                    <table class="table-auto w-full "> 
                      ...
                      <tbody>
                      <tr v-for ="(user, index) in users.data" :key='index' :class="{'bg-gray-200 ':index%2===0}"> 
                        <th class="px-2 py-2 mb-1 text-left text-sm font-semibold">{{user.id}} </th> 
                        <th class="px-2 py-2 mb-1 text-left text-sm font-semibold"> {{user.nrna_id}} </th> 
                        <th class="px-2 py-2 mb-1 text-left text-sm font-semibold"> {{user.first_name}} </th>
                        <th class="px-2 py-2 mb-1 text-left text-sm font-semibold"> {{user.last_name}} </th>
                        <th class="px-2 py-2 mb-1 text-left text-sm font-semibold"> {{user.telephone}} </th>
                        <th class="px-2 py-2 mb-1 text-left text-sm font-semibold"> {{user.state}} </th>                        
                        <th class="px-2 py-2 mb-1 text-left text-sm font-semibold"> {{user.created_at}} </th>
                       </tr> 
                       </tbody>
                    </table>
                </div>
